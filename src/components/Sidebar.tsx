    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'penilaian-teman', label: 'Penilaian Antar Teman', icon: <Users2 className="w-5 h-5 text-indigo-400" /> },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'rekap-penilaian-teman', label: 'Rekapan Penilaian Antar Teman', icon: <Users2 className="w-5 h-5 text-indigo-400" /> },
